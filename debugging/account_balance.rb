...
# It looks like balance is being reassigned instead of incremented each time
# through the .each. We could fix this by performing this iteration on the array
# of months
